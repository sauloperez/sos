...
public abstract class DeleteObservationCacheFeederDAO extends DatasourceCacheUpdate {
     ...
     */
    protected void updateFeatureOfInterest() {
     ...
     *         offering
     */
    protected abstract boolean isLastForOffering(String feature, String offering);
     ...
     *         dbProcedure.
     */
    protected abstract boolean isLastForProcedure(String feature, String procedure);

    protected abstract DateTime getMaxDateForOffering(String offering);

    protected abstract DateTime getMinDateForOffering(String offering);

    protected abstract DateTime getMaxDateForProcedure(String procedure);

    protected abstract DateTime getMinDateForProcedure(String procedure);
    ...
    protected abstract DateTime getMaxResultTimeForOffering(String offering);

    protected abstract DateTime getMinResultTimeForOffering(String offering);
