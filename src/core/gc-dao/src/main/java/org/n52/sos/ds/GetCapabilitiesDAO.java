...
public class GetCapabilitiesDAO extends AbstractGetCapabilitiesDAO {
    ...
    private List<CapabilitiesExtension> getAndMergeExtensions(final String service, final String version)
            throws OwsExceptionReport {
        List<CapabilitiesExtensionProvider> capabilitiesExtensionProviders =
        ...
        if (CollectionHelper.isNotEmpty(capabilitiesExtensionProviders)) {
            ...
            for (CapabilitiesExtensionProvider capabilitiesExtensionDAO : capabilitiesExtensionProviders) {
    ...
    private boolean isHiddenChildProcedureObservableProperty(String offering,
            Set<String> proceduresForObservableProperty) {
        for (String hiddenProcedure : getCache().getHiddenChildProceduresForOffering(offering)) {
    ...
    protected void setUpProcedureDescriptionFormatForOffering(final SosObservationOffering sosOffering, String version) {
