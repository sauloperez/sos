...
public abstract class AbstractWmlEncoderv20 extends AbstractOmEncoderv20 {
    ...
    protected static final Set<EncoderKey> DEFAULT_ENCODER_KEYS = CodingHelper.encoderKeysForElements(
            WaterMLConstants.NS_WML_20, ObservationProcess.class, AbstractFeature.class);
