...
public class FeatureOfInterestEnrichment extends ProcedureDescriptionEnrichment {
    ...
    public void enrich() throws OwsExceptionReport {
        ...
        if (procedureSettings().isEnrichWithFeatures()) {
            Collection<String> features = getFeatureOfInterestIDs();
            if (CollectionHelper.isNotEmpty(features)) {
                getDescription().addFeaturesOfInterest(features);
            }
        }
    }
     ...
     */
    private Collection<String> getFeatureOfInterestIDs() throws
            OwsExceptionReport {
